...
const EntityClient = () => {
    ...
    useEffect(() => {
        if (showActive) {
            getAllEntities();  // Fetch active entities
        } else {
    ...
    return (
        <div className="d-flex">
            <Container fluid>
                ...
                <div
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {showYears && (
                                        <ul className="entity-years-list">
                                            <li>2023</li>
                                            <li>2022</li>
                                            <li>2021</li>
                                            <li>2020</li>
                    ...
                    <div className=" d-flex justify-content-end custom-table-search">
                        ...
                        >
                            <option value="active">{showActive ? "Active" : "Inactive"}</option>
                                                    ...
                                                    <Select
                                                        value={
                                                            ReportingPeriodOptions.find(
                                                                (option) => option.value === (editingData?.reporting_period || '')
                                                            ) || null
                                                        }
                                                        onChange={(e) => ReportingPeriodhandleDataChange(e, 'reporting_period')}
                                    ...
                                    <div className="row pt-1 mt-1">
                                        ...
                                        <div className="col-md-4 text-left mt-1">
                                            ...
                                            <Controller
                                                ...
                                                control={formEntity.control}
                                                defaultValue={editData ? editData.reporting_period : ''}
                                                rules={{ required: true }}
                                                render={({ field }) => (
                                                    <Select
                                                        {...field}
                                                        ...
                                                        className="react-select-container"
                                                        onChange={(selectedOption) => field.onChange(selectedOption?.value)}
                                                        value={ReportingPeriodOptions.find(option => option.value === field.value)}
            ...
            <div className="model_box ">
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Entity Name - {selecteTan}</Modal.Title>

                    </Modal.Header>

                    <Modal.Body className="custom-modal-body p-0">
                        <Tabs defaultActiveKey="basic" id="entity-tabs" className="popup-tabs">
                            {/* === TAB 1: BASIC DETAILS === */}
                            ...
                            <Tab eventKey="Modules" title="Modules" >
                                <div className="tab-form-body">
                                    <p>Placeholder content for Modules  tab.</p>
                                    {/* Add your inputs / logic for Financial Years here */}
                                </div>
                            </Tab>
                            ...
                            {/* === TAB 4: RANDOM TAB === */}
                            <Tab eventKey="random" title="Random Tab">
                                <div className="tab-form-body">
                                    <p>Placeholder content for Random Tab.</p>
