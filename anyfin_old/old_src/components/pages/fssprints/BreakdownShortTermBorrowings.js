...
const BreakdownShortTermBorrowings = () => {
    ...
    const API_URL = "http://demo.anyfinancials.in:1234/api/breakdown/25"; // Replace with actual API URL
                ...
                <tbody>
                    {data.Details.map((item, index) => (
                        <tr key={index} >
                            ...
                            <td>{item.current_year.toLocaleString()}</td>
                            <td>{item.previous_year.toLocaleString()}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
...
export default BreakdownShortTermBorrowings;
