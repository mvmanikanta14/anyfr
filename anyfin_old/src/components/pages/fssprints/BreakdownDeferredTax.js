...
const BreakdownDeferredTax = () => {
    ...
    const API_URL = commonService.getAll(apiUrlsService.getBreakdown24); // Replace with actual API URL
...
export default BreakdownDeferredTax;
