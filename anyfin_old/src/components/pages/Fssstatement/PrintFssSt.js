...
const PrintFssSt = () => {
    const [PrintFssSt, setPrintFssSt] = useState([]); // Initialize as an empty array
    const [PrintFssStUnload, setPrintFssStUnload] = useState([]); // Initialize as an empty array
    ...
    const getAllNavigation = () => {
        commonService.getAll(apiUrlsService.getNavigationPrintFss).then((response) => {
            if (response && response.data) {
    ...
    const getAllPrintFssSt = () => {
        commonService.getAll(apiUrlsService.getPrintFssST).then((response) => {
            if (response && response.data) {
                setPrintFssSt(response.data);
            }
        }).catch((error) => {
            handleApiError(error);
        });
    ...
    const getAllEditPopup = () => {
        commonService.getAll(apiUrlsService.getEditFSSPrint).then((response) => {
            if (response && response.data) {
    ...
    const getAllFssOptions = () => {
        commonService.getAll(apiUrlsService.getPrintFssStActions).then((response) => {
            if (response && response.data) {
