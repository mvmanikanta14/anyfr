...
const GroupSummary = () => {
    ...
    const [groupsummaryAdd,setgroupsummaryAdd]=useState();
    ...
    const getAllgroupsummary = () => {
        commonService.getAll(apiUrlsService.getGroupsummary).then(
            (response) => {
    ...
    const onSubmit = (data) => {
        ...
        if (!ids) {
          commonService
            .add(apiUrlsService.addgroupsummary, data)
            .then((res) => {
              console.log("API Response:", res); // Check if response exists
              if (res) {
                setgroupsummaryAdd([...groupsummaryAdd, res.data]); // Update state
        ...
        <div className=" ">
            <div className=" ">
                ...
                <div className="bread_crumb">
                    <div className=" ">
                        <h3 className="header-title">Group Summary </h3>
                    </div>
                            ...
                            <table className="table table-striped table-bordered table-hover table_custom_1">
                                ...
                                <tbody>
                                    {groupsummary && groupsummary.length > 0 ? (
                                        groupsummary.slice().reverse().map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td>{item.total_acquisition_value}</td>
