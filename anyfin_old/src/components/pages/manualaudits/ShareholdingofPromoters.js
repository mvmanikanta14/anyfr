...
const ShareholdingofPromoters = () => {
    ...
    const getAllShareFormReconciliation = () => {
        commonService.getAll(apiUrlsService.getAllSharePromoters)
            .then((response) => {
    ...
    const onSubmit = (data) => {
        const requestData = {
            name_of_promoter: data.name_of_promoter || "",
            previous_year: "2023",
        ...
        if (!ids) {
            commonService.add(apiUrlsService.addSharePromoters, requestData)
                .then((res) => {
    ...
    const updateShareReconciliation = (id, updatedData) => {
        ...
        console.log(`Sending API request to: ${apiUrlsService.editSharePromoters}/${id}`, requestData);
                                    ...
                                    {tableData && tableData.length > 0 ? (
                                        tableData.map((item, index) => (
                                            <tr key={item.id || index}>
                                                <td>{index + 1}</td>
                                                <td>{item.name_of_promoter || "N/A"}</td>
                                                ...
                                                <td>{item.previous_year_percentage || "N/A"} </td>
                                            </tr>
                                        ))
                                    ) : (
                                        <tr>
                                    ...
                                    <div className="row pt-1 mt-1">
                                        ...
                                        <div className="col-md-4 text-left mt-1 ">
                                            ...
                                            <input
                                                ...
                                                {...register("name_of_promoter", {
                                                    required: true,
                                                })}

                                                defaultValue={editData ? editData.name_of_promoter : ""} // Set initial value based on editData
                                            />
                                            {errors.name_of_promoter && (
...
export default ShareholdingofPromoters;