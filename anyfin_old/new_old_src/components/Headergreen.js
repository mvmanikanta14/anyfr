        ...
        <div className="w-100">
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="entity-name-header d-flex justify-content-between align-items-center">
              <h5> <IconBuilding className="opacity-8" /> E_ID_{companyId} - E_Name_{companyName} </h5>
              <div className="entity-logout"> <Link className="Link-color" onClick={logoutEntity}> <IconLogout /> </Link> </div>
            </div>
