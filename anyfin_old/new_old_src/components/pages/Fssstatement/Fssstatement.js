...
const Fssstatement = () => {
    ...
    const getAllFssTrialbalanceload = () => {
        commonService.getAll(apiUrlsService.getFssStatements).then((response) => {
            if (response && response.data) {
    ...
    const getAllFssOptions = () => {
        commonService.getAll(apiUrlsService.getAllFssstatementsOptions).then((response) => {
            if (response && response.data) {
