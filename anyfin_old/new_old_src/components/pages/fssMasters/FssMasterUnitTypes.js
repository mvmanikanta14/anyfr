...
const FssMasterUnitTypes = () => {
    const [FssMasterUnitTypes, setFssMasterUnitTypes] = useState([]);
    const [FssMasterUnitTypesAdd, setFssMasterUnitTypesAdd] = useState([]);
    ...
    const deleteFssMasterUnitTypes = (id) => {
        // Construct the correct API URL with the ID
        const deleteUrl = `${apiUrlsService.deleteFssMasterUnitTypes}/${id}`;
        ...
        commonService.deleteById(deleteUrl)
            .then((response) => {
                ...
                if (response.data.success) {
                    ...
                    getAllFssMasterUnitTypes(); // Refresh the list
                } else {
    ...
    const getAllFssMasterUnitTypes = () => {
        let pagedata = {
        };

        commonService.add(apiUrlsService.getFssMasterUnitTypes, pagedata).then(
            (response) => {
                if (response && response.data) {
                    console.log("mani", response.data)
                    setFssMasterUnitTypes(response.data);
    ...
    const onSubmit = (data) => {
        ...
        if (!ids) {
            // ADD Operation
            commonService.add(apiUrlsService.addFssMasterUnitTypes, requestData)
                .then((res) => {
                    setFssMasterUnitTypesAdd([...FssMasterUnitTypesAdd, res.data]);
            ...
            commonService.update(`${apiUrlsService.editFssMasterUnitTypes}/${editData.id}`, requestData)
                .then((response) => {
                    if (response) {
                        const updatedFssMasterUnitTypes = FssMasterUnitTypes.map((item) =>
                            item.id === editData.id ? response.data : item
                        );
                        console.log("Updated Data:", updatedFssMasterUnitTypes);
                        setFssMasterUnitTypesAdd(updatedFssMasterUnitTypes);
    ...
    const handleShowEdit = (id) => {
        const itemToEdit = FssMasterUnitTypes.find((item) => item.id === id)
    ...
    const activeShares = FssMasterUnitTypes.filter(item => item.is_active);
    const inactiveShares = FssMasterUnitTypes.filter(item => !item.is_active);
        ...
        <div className="">
            <div className="">
                <div className="bread_crumb">
                    <div className=" ">
                        <h3 className="header-title"> Unit Types</h3>
                    </div>
                                                        ...
                                                        {showActive ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <button
                                                                    ...
                                                                    title="Delete"
                                                                    onClick={() => deleteFssMasterUnitTypes(item.id)}
                                                                >
                                                                    <IconTrash />
                                                                </button>
                                                            </>
                                    ...
                                    <div className="row pt-1 mt-1">
                                        ...
                                        <div className="col-md-4 text-left mt-1 ">
                                            ...
                                            <input
                                                ...
                                                defaultValue={editData ? editData.unit_type_name : ""} // Set initial value based on editData
                                            />
...
export default FssMasterUnitTypes;
