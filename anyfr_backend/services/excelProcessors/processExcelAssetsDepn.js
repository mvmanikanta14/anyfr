...
const ModuleAssetsDepnRawService = require('../../src/services/dbServices/moduleAssetsDepnRaw');
const moduleAssetsDepnRawService = new ModuleAssetsDepnRawService(); // Add subdomain if needed
...
const processExcelAssetsDepn = async ({ fileKey , organisation_id, entity_id, created_by  }) => {
