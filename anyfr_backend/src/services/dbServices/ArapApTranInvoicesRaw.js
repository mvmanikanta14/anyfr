...
class ArapApTranInvoicesRaw {
  ...
  async create({
    ...
    const query = `
      INSERT INTO arap_ap_tran_invoices (
        organisation_id,
        entity_id,
        invoice_date,
        invoice_number,
...
module.exports = ArapApTranInvoicesRaw;
