...
class FssParamOepRectificationRaw {
  ...
  async getAll(page = 1, limit = 10,entity_id, organisation_id, period_id) {
    ...
    const countQuery = `
      ...
      WHERE transaction_type=3 AND  entity_id = $1 AND organisation_id = $2 and period_id = $3`;
...
module.exports = FssParamOepRectificationRaw;
